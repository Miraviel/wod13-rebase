...
GLOBAL_LIST_INIT(dye_registry, list(
	DYE_REGISTRY_UNDER = list(
		...
		DYE_PRINCE = /obj/item/clothing/under/rank/captain,
	...
	DYE_REGISTRY_JUMPSKIRT = list(
		...
		DYE_PRINCE = /obj/item/clothing/under/rank/captain/skirt,
	...
	DYE_REGISTRY_GLOVES = list(
		...
		DYE_PRINCE = /obj/item/clothing/gloves/captain,
	...
	DYE_REGISTRY_SNEAKERS = list(
		...
		DYE_PRINCE = /obj/item/clothing/shoes/sneakers/brown,
	...
	DYE_REGISTRY_BEDSHEET = list(
		...
		DYE_PRINCE = /obj/item/bedsheet/captain,
		...
		DYE_PRINCE = /obj/item/bedsheet/captain/double,
