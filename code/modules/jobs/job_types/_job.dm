...
//WOD13TODO: Make sure only the Prince has this proc...
/datum/job/proc/get_prince_announcement(mob/living/prince)
	return "Due to extreme staffing shortages, newly promoted Acting Captain [prince.real_name] on deck!"
